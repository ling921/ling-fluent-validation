...
internal static class EquatableArray
{
    ...
    /// <summary>
    /// Creates an <see cref="EquatableArray{T}"/> instance from a given <see cref="IEnumerable{T}"/>.
    /// </summary>
    /// <typeparam name="T">The type of items in the input array.</typeparam>
    /// <param name="collection">The input <see cref="IEnumerable{T}"/> instance.</param>
    /// <returns>An <see cref="EquatableArray{T}"/> instance from a given <see cref="IEnumerable{T}"/>.</returns>
    public static EquatableArray<T> ToEquatableArray<T>(this IEnumerable<T> collection)
        where T : IEquatable<T>
    {
    ...
    where T : IEquatable<T>
{
    ...
    /// Creates a new <see cref="EquatableArray{T}"/> instance.
    /// </summary>
    /// <param name="collection">A collection of items to wrap.</param>
